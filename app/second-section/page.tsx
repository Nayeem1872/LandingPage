...
const features = [
    {
        ...
        image: "/image/icon-support-1.png",
        alt: "Customizable",
        color: "blue"
      },
      {
...
flex  justify-center pb-10
        ...
        ">
            <div className="p-5 justify-center md:w-1/3">
                ...
                ">
                    From startup to enterprise, nErim is built for every type of business.

                </div>
                <div className="text-2xl mb-8">
                Built for all businesses and communities,nErim is the only platform you need to grow your business.
